...
typedef enum {NO_ANIMATION, A_BATTERY, A_SELECTTHRESHOLD , A_SELECTINTERVAL,A_CHANGETHRESHOLD,A_CHANGEINTERVAL, A_TRANSITIONING_CONF, A_TRANSITIONING_TIMEOUT,A_TRANSITIONING_SHUTDOWN, A_TRANSITIONING_STARTUP, A_MANUALIRRIGATION} currentLEDAnimation;
